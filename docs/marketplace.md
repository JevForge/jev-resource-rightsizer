...
- Release edit (publish checkbox): https://github.com/JevForge/jev-resource-rightsizer/releases/edit/v0.1.11
- Expected Marketplace URL: https://github.com/marketplace/actions/jev-resource-rightsizer

## Listing copy

- **Name:** JEV Resource RightSizer
- **Short description (≤125 chars):** Recommend scale-down, keep, scale-up, or review from metrics for your CI/CD workflow.
